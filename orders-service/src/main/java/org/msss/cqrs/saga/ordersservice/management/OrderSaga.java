package org.msss.cqrs.saga.ordersservice.management;

import org.msss.cqrs.saga.ordersservice.command.api.ApproveOrderCommand;
...
import org.msss.cqrs.saga.ordersservice.model.OrderSummary;
import org.msss.cqrs.saga.ordersservice.query.api.FindOrderQuery;
...
import org.msss.cqrs.saga.shared_common.command.CancelProductReservationCommand;
import org.msss.cqrs.saga.shared_common.command.ProcessPaymentCommand;
import org.msss.cqrs.saga.shared_common.command.RejectOrderCommand;
import org.msss.cqrs.saga.shared_common.command.ReserveProductCommand;
import org.msss.cqrs.saga.shared_common.event.PaymentProcessEvent;
import org.msss.cqrs.saga.shared_common.event.ProductCancelReservationEvent;
import org.msss.cqrs.saga.shared_common.event.ProductReserveEvent;
...
public class OrderSaga {
    ...
    public void handle(OrderCreateEvent orderCreateEvent) {
        ...
        commandGateway.send(rpc, (commandMessage, commandResultMessage) -> {
    ...
    private String cancelProductReservation(String reason, ProductReserveEvent event) {
        ...
        return commandGateway.sendAndWait(can);
